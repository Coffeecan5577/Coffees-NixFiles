  ...
  flake.modules.homeManager.shell-fish = { config, lib, pkgs, ... }: {
    programs.fish = {
      ...
      shellAliases = {
        ...
        update-Nix-Flake = "nix flake update ~/Coffees-NixFiles/full-systems/Coffees-NixOS";
        config-Nix-Flake = "nvim ~/Coffees-NixFiles/full-systems/Coffees-NixOS/flake.nix";
        config-Nix-Modules = "nvim ~/Coffees-NixFiles/full-systems/Coffees-NixOS/modules";
